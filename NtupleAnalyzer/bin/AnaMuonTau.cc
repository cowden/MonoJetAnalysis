...
int main(int argc, char ** argv) 
{
  ...
  hDataMcMatching DataMcMatching0(histFile+"_AnaMuonTau_0.root");
  ...
  manager.Add(&CMet);
  //manager.Add(&CGenZPt);
  hDataMcMatching DataMcMatching1(histFile+"_AnaMuonTau_1.root");
  ...
  */
  ...
  hDataMcMatching DataMcMatching2(histFile+"_AnaMuonTau_2.root");    
  ...
  //manager.Add(&CJet20);
  hDataMcMatching DataMcMatching3(histFile+"_AnaMuonTau_3.root");    
  ...
  CutNJet CNJet(3);
  manager.Add(&CNJet);
  hDataMcMatching DataMcMatching4(histFile+"_AnaMuonTau_4.root");
  ...
  hDataMcMatching DataMcMatching5(histFile+"_AnaMuonTau_5.root");
  ...
  hDataMcMatching DataMcMatching6(histFile+"_AnaMuonTau_6.root");
  ...
  hDataMcMatching DataMcMatching7(histFile+"_AnaMuonTau_7.root");
  ...
  hDataMcMatching DataMcMatching8(histFile+"_AnaMuonTau_8.root");
  ...
  hDataMcMatching DataMcMatching9(histFile+"_AnaMuonTau_9.root");   
  ...
  hDataMcMatching DataMcMatching10(histFile+"_AnaMuonTau_10.root");
  ...
  hDataMcMatching DataMcMatching11(histFile+"_AnaMuonTau_11.root");
  ...
  hDataMcMatching DataMcMatching12(histFile+"_AnaMuonTau_12.root");  
  ...
  hDataMcMatching DataMcMatching13(histFile+"_AnaMuonTau_13.root");
