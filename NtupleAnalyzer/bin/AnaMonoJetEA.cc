...
{  
  ...
  hDataMcMatching DataMcMatching0(histFile+"_AnaMonoJetEA_0.root"); 
  manager.Add(&DataMcMatching0);
  
  
  CutMet CMet(200); 
  manager.Add(&CMet);
  hDataMcMatching DataMcMatching1(histFile+"_AnaMonoJetEA_1.root"); 
  ...
  */
  hDataMcMatching DataMcMatching2(histFile+"_AnaMonoJetEA_2.root"); 
  ...
  //manager.Add(&CJet20);
  hDataMcMatching DataMcMatching3(histFile+"_AnaMonoJetEA_3.root"); 
  ...
  CutNJet CNJet(3);
  manager.Add(&CNJet);
  hDataMcMatching DataMcMatching4(histFile+"_AnaMonoJetEA_4.root"); 
  manager.Add(&DataMcMatching4);
  
  
  CutDeltaPhi3 CDeltaPhi3(2.5);
  manager.Add(&CDeltaPhi3);
  hDataMcMatching DataMcMatching5(histFile+"_AnaMonoJetEA_5.root"); 
  ...
  hDataMcMatching DataMcMatching6(histFile+"_AnaMonoJetEA_6.root");
  manager.Add(&DataMcMatching6);
  
  
  NoPFElec CNoPFElec(10., 66.);
  manager.Add(&CNoPFElec); // no cut on eta
  hDataMcMatching DataMcMatching7(histFile+"_AnaMonoJetEA_7.root");
  manager.Add(&DataMcMatching7);
  
  
  //CutTau CTau(1,1);
  //manager.Add(&CTau);
  //hDataMcMatching DataMcMatching8(histFile+"_AnaMonoJetEA_8.root");
  ...
  hDataMcMatching DataMcMatching9(histFile+"_AnaMonoJetEA_9.root"); 
  ...
  hDataMcMatching DataMcMatching10(histFile+"_AnaMonoJetEA_10.root"); 
  ...
  hDataMcMatching DataMcMatching11(histFile+"_AnaMonoJetEA_11.root"); 
  ...
  hDataMcMatching DataMcMatching12(histFile+"_AnaMonoJetEA_12.root"); 
  ...
  hDataMcMatching DataMcMatching13(histFile+"_AnaMonoJetEA_13.root");
  ...
  hDataMcMatching DataMcMatching14(histFile+"_AnaMonoJetEA_14.root");
  ...
  hDataMcMatching DataMcMatching15(histFile+"_AnaMonoJetEA_15.root"); 
